---
layout: default
title: "Forgiven and Free: A Lutheran Guide to Freedom"
---

# Forgiven and Free: A Lutheran Guide to Freedom
...
1. [Introduction — Why This Book Exists]({{ site.baseurl }}/chapters/01-introduction)
2. [The Easy Method — A New Frame of Mind]({{ site.baseurl }}/chapters/02-the-easy-method)
3. [Why Is It Difficult to Stop? — The Sinister Trap]({{ site.baseurl }}/chapters/03-the-sinister-trap)
4. [The Neuroscience of the Trap — Dopamine, Novelty, and the Reward Circuit]({{ site.baseurl }}/chapters/04-neuroscience-of-the-trap)
5. [The Little Monster — Understanding Physical Withdrawal]({{ site.baseurl }}/chapters/05-the-little-monster)
6. [The Backward Mechanism — Why Porn Gets Credit for What It Causes]({{ site.baseurl }}/chapters/06-the-backward-mechanism)
7. [Crossing the Red Line — Tolerance, Escalation, and Desensitization]({{ site.baseurl }}/chapters/07-crossing-the-red-line)
8. [The Big Monster — Brainwashing and the Devil's Lies]({{ site.baseurl }}/chapters/08-the-big-monster)
9. [Law Cannot Save — Why Willpower Is a Theology of Glory]({{ site.baseurl }}/chapters/09-law-cannot-save)
10. [Deconstructing the Lies — Stress and Relaxation]({{ site.baseurl }}/chapters/10-stress-and-relaxation)
11. [Deconstructing the Lies — Boredom, Concentration, and Energy]({{ site.baseurl }}/chapters/11-boredom-concentration-energy)
12. [What Am I Giving Up? — Absolutely Nothing]({{ site.baseurl }}/chapters/12-what-am-i-giving-up)
13. [The Void — Porn Doesn't Fill It, It Creates It]({{ site.baseurl }}/chapters/13-the-void)
14. [The Willpower Method in Detail — Romans 7 Without Romans 8]({{ site.baseurl }}/chapters/14-willpower-method-in-detail)
15. [Beware of Cutting Down — The Porn Diet Trap]({{ site.baseurl }}/chapters/15-beware-of-cutting-down)
16. [Just One Peek — The Serpent's Oldest Lie]({{ site.baseurl }}/chapters/16-just-one-peek)
17. [Casual Users and the Illusion of Control]({{ site.baseurl }}/chapters/17-casual-users)
18. [The Social Media Trap — Feeding the Monster Through the Side Door]({{ site.baseurl }}/chapters/18-social-media-trap)
19. [Timing — When Is the Right Time? Now.]({{ site.baseurl }}/chapters/19-timing)
20. [Will I Miss the Fun? — The Envy Trap]({{ site.baseurl }}/chapters/20-will-i-miss-the-fun)
21. [False Incentives and the Theology of the Cross]({{ site.baseurl }}/chapters/21-false-incentives)
