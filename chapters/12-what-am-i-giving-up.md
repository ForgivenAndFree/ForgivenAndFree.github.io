...
It was not designed to handle supernormal stimuli. It was not built to process an endless stream of novel sexual imagery at the click of a button. There is no evolutionary precedent for it. There is no biological preparation for it. When you flood this exquisitely calibrated system with stimulation it was never meant to handle, it breaks. Not dramatically — not like a bone snapping — but slowly, insidiously, like a river eroding a canyon. The fail-safe mechanisms kick in: tolerance, desensitization, withdrawal. These are your body's warning systems, screaming at you that something is wrong.
